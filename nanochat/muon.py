...
#TODO (Hamidreza): return back to this later for better understanding, now just copied it from original nanochat repo.
...
class Muon(torch.optim.Optimizer):
    ...
    # step is where the updates happen, no grad tracking
    @torch.no_grad()
    def step(self):
